...
static dlist_element *WSP_routing( hash_table *node_table, uint64_t in_dpid, uint16_t in_port_no, uint64_t out_dpid, uint16_t out_port_no );
static bool comp_dlist( const void *x0, const void *y0 );
static unsigned int hash_dlist( const void *key0 );
